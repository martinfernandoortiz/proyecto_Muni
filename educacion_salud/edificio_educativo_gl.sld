      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <!--<se:ExternalGraphic>
                <se:OnlineResource xlink:href="edificio_educativo_glprueba.svg" xlink:type="simple"/>
    ...
    <se:Rule>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
           <se:ExternalGraphic>
                <se:OnlineResource xlink:href="edificio_educativo_gl.svg" xlink:type="simple"/>
                <se:Format>image/svg+xml</se:Format>
              </se:ExternalGraphic>
              <se:Mark>
                <se:WellKnownName>file://edificio_educativo_gl.svg</se:WellKnownName>
                <se:Fill>
