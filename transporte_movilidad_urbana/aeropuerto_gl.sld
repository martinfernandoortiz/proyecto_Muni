      ...
      <se:FeatureTypeStyle>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                ...
                <!--<se:Stroke>
                  <se:SvgParameter name="stroke">54A868</se:SvgParameter>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                <se:WellKnownName>circle</se:WellKnownName>
                <se:Fill>
                  <se:SvgParameter name="fill">54A868</se:SvgParameter>
                  <se:SvgParameter name="fill-opacity">0.8</se:SvgParameter>
                </se:Fill>
                  <se:Stroke>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:ExternalGraphic>
                <se:OnlineResource xlink:type="simple" xlink:href="aeropuerto_gl.svg" />
