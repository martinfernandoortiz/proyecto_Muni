      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <!--<se:ExternalGraphic>
                <se:OnlineResource xlink:href="universidad_gl.svg" xlink:type="simple"/>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              ...
              <se:Mark>
                <se:WellKnownName>file://universidad_visor_gl_.svg.svg</se:WellKnownName>
                <se:Fill>
                  <se:SvgParameter name="fill">#a58c67</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              ...
              <se:Mark>
                <se:WellKnownName>file://universidad_visor_gl_.svg</se:WellKnownName>
                <se:Fill>
                  <se:SvgParameter name="fill">#a58c67</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
